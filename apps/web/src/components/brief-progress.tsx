    ...
    return (
      <section className="surface mt-8 p-6 text-center">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/companion"
            className="rounded bg-[var(--accent)] px-3 py-1.5 text-[13px] font-medium text-white"
          >
            Ask the Companion
          </a>
          <a
  ...
  return (
    <section className="surface mt-8 flex flex-col items-center gap-3 p-5 text-center">
      ...
      <button
        ...
        className="rounded bg-[var(--accent)] px-4 py-2 text-[13px] font-medium text-white disabled:opacity-60"
      >
