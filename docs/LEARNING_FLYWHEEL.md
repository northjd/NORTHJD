# The Personal Knowledge Flywheel
...
The mechanism by which daily reading becomes durable competence rather than a stream
...
The second is what stops evergreen content going stale in the reader's mind.

**Built.** Materially improved by inferring industry from matched KPIs and value chain
...
**No streaks, no daily-goal pressure, no loss aversion.** Those work by making people
anxious, and this is a professional tool.

**Partially built** — intervals are written; no scheduler consumes them, and the Weekly
...
**Built**, with the limitation that adaptation is currently a ranking weight rather than
a curriculum.
...
The brief rules them out, and it is right to. Streaks work through loss aversion: the
cost of breaking one is what drives the behaviour. That produces attendance rather than
learning, and it is exactly the mechanic that makes social feeds work.

What is used instead: spaced resurfacing, short reflection prompts, "what changed since
you learned this", and a visible knowledge state the user can correct. All of them work
by being useful rather than by being uncomfortable to abandon.
