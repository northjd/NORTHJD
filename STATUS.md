...
### Phase 2 — Vertical intelligence slice *(the first mandatory milestone)*
...
### Phase 5–7 — Learning, meetings, explore *(partial)*
...
- Company pages with timelines, implementation-maturity mix, and source coverage
  including what is *not* monitored
...
**Demo, badged everywhere:** two demo sources (*Demo Corporate Newsroom* first-party,
*Demo Trade Press* independent) serving six fixtures, and four fictional companies
...
- Extractive generation reads as assembled rather than written. Labelled *Extractive*
